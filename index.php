	...
	<body>
		...
		<div>
			<div class="slider">
			    <ul class="slides">
			      <li>
			        <img src="assets/images/gg.jpg"> <!-- random image -->
      ...
      <div class="activities">
      	<div class="container">
      		...
      		<div class="row">
			    <div class="col m3">
			    	<img class="responsive-img img-thumbnail" src="assets/images/gg.jpg">
		  	...
		  	<div class="row">
		  		<div class="col s12 m6">
					  ...
					  <div class="carousel carousel-slider">
					    <a class="carousel-item" href="#one!"><img src="assets/images/gg.jpg"></a>
